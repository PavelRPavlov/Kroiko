...
| [0010](0010-host-pwa-on-s3-and-cloudfront.md) | Host the PWA on Amazon S3 + CloudFront (flat-rate Free plan) at `app.kroiko.com` | Accepted; the origin (§1) superseded by [0011](0011-serve-pwa-at-kroiko-com-with-route-53.md) |
