...
| 07 | [Hosting & go-live](07-hosting-and-go-live.md) | 07a: S3 + CloudFront (Free plan) + first manual deploy; 07b: release checklist, go-live sign-off | [0010](../adr/0010-host-pwa-on-s3-and-cloudfront.md), [0011](../adr/0011-serve-pwa-at-kroiko-com-with-route-53.md), [0007](../adr/0007-parity-and-test-strategy.md) §9 | In progress |
