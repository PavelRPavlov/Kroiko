...
/// any bad line → a log entry and no Details; a clean file → its Details and no log entry. Only files it rejected for
/// their line endings now parse (ADR-0006 §1); the parser itself is tested in <c>Kroiko.Domain.Tests</c>.
/// </summary>
